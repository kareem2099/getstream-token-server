...
app.use(cors({
    ...
    methods: ['GET', 'POST', 'OPTIONS'],  // Ensure the necessary HTTP methods are allowed
...
app.post('/generate-api-key', (req, res) => {
    const payload = { role: 'admin', apiKey: process.env.JWT_SECRET };  // You can modify this payload
